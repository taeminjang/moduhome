...
<!-- <script type="text/javascript"
	src="//cdn.ggumim.co.kr/resource/house_interior_web/ggumim.stack-1.2.04.min.js"></script>
	  -->
<script type="text/javascript"
	src="/ModuHome/js/store/ggumim.stack-1.2.04.min.js"></script>
<link type="text/css" rel="stylesheet"
	href="/ModuHome/css/store/ggumim-1.2.04.min.css" />
</head>
<body class="">
		...
		<div class="head-bar head-bar-white">
			<div class="navigation">
				<div style="position: absolute; left: 200px;">
					<a href="/">
						<div class="logo">
							<!-- <img src="//cdn.ggumim.co.kr/storage/20170913181151ZShWGut1NY.png" alt=""> -->
...
.container {
	...
	<!-- herina script start common -->
	<script type="text/javascript">
		window.herina_obj = {};
		window.herina_obj.shop_id = "theggumim";
		window.herina_obj.domain = "ggumim.co.kr";
	</script>
	<!-- herina script end common -->
	<!-- herina script start product view 1st -->
	<script type="text/javascript">
		window.herina_obj.item_name = '사틴 커트러리 세트';
		window.herina_obj.item_image1 = '//cdn.ggumim.co.kr/cache/furniture/600/20180820185305D8r6zjRFhR.jpg';
		window.herina_obj.item_image2 = '//cdn.ggumim.co.kr/cache/furniture/600/20180820185305D8r6zjRFhR.jpg';
		window.herina_obj.item_image3 = '//cdn.ggumim.co.kr/cache/furniture/600/20180820185305D8r6zjRFhR.jpg';
		window.herina_obj.product_price = '20800';
		window.herina_obj.product_no = '29976';
		var hearinaProd = '29976';
		window.herina_obj.category1 = '주방';
		window.herina_obj.category2 = '주방용품';
		window.herina_obj.category3 = '커트러리';
	</script>
	...
	<div class="container">
				...
				<div class="col-xs-6 furniture-view-infomation">
					...
					<div class="furniture-view-option ">
						<div class="option-set">
							<div class="option-title">컬러</div>
							<div class="option-item-group" id="optionset0">
								<div class="option-item" data-idx="56885"
									onclick="FurnitureView.clickOption(0,this)">마호가니</div>
								<div class="option-item" data-idx="56886"
									onclick="FurnitureView.clickOption(0,this)">에보니</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="furniture-view-body">
				<div class="furniture-image" id="image_idx_67297">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184558JNJz0GcE6W.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67287">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184543VvRiRo3dgf.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67289">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/201808201845442V0UhkOlA2.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67271">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184533USqhRXtH0S.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67273">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184534HHQx4F7ttJ.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67291">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184549qTKsqqyTAo.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67267">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184533haTCcLWQqv.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67269">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184534m6ERoiue0y.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67277">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184540WXZXRhemtE.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67275">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184536dnlwKmScOm.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67288">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184547e6QeEsEsRQ.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67274">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184535Q8FdBQ3WEY.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67278">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184537yZ2QQ0jx0c.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67285">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184542MdyR69ZvIG.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67279">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184539hQ0bSjndRF.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67296">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184554H5vXSxYxWZ.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67280">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184541AOb7FXsw2x.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67295">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184554Gs08kGGRjD.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67282">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/201808201845401eOB2GMyoq.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67281">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184539wuAmuhZppf.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67284">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184542lldtsZVGPq.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67294">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184548JMCITjqAaY.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67272">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184534eIoYlgSiCV.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67264">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184531fCc7tqZ7v0.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67298">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184821sKA4r7o0cy.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67276">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/201808201845391gfWduH8XH.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67268">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184533cCVlSaY4hr.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67292">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184547h2TkSnm1pp.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67290">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184545OMbJndYcO0.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67270">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184532GCU8gbYWLP.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67293">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184550kkMSO8ZjHu.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67283">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/201808201845436lsx7ufsqQ.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67265">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/201808201845297YaFbIYHqG.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<!--/.furniture-content-->
				<div class="furniture-image" id="image_idx_67286">
					<img
						src="//cdn.ggumim.co.kr/cache/furniture_desc/1000/20180820184543E2Qu2922mm.jpeg"
						class="main-img" width="600" />
				</div>
				<!--/.furniture-image-->
				<div class="furniture-content">
				...
				<div id="furniture-together-list"
					...
					<div class="furniture-slick-item">
						<a href="/furniture/view/14760"> <img
							src="//cdn.ggumim.co.kr/cache/furniture/600/201607021940018N3wq1SbJi.png" />
						</a>
						<div class="description">
	...
	<!--
		...
		function mobRfShop() {
			sh = new EN();
			// [상품상세정보]
			sh.setData("sc", "8c8ef371f7e45bd49e885e4fa3fb96bc");
			sh.setData("userid", "ndysjo");
			sh.setData("pcode", "29976");
			sh.setData("pnm",
					encodeURIComponent(encodeURIComponent("사틴 커트러리 세트")));
			sh
					.setData(
							"img",
							encodeURIComponent("//cdn.ggumim.co.kr/cache/furniture/600/20180820185305D8r6zjRFhR.jpg")); //전체URL(http포함)
			sh.setData("price", "20800");
			sh.setData("cate1", encodeURIComponent(encodeURIComponent("주방"))); //있을경우
			sh.setSSL(true);
			sh.sendRfShop();
		}
		//-->
	...
	<script>
		Stack
				.add(function() {
					...
					FurnitureView
							.setUnit('{"56885-":{"unitIdx":219575,"price":20800,"name":"\ub9c8\ud638\uac00\ub2c8","count":245,"count_type":0,"status":1,"sold":1},"56886-":{"unitIdx":219576,"price":20800,"name":"\uc5d0\ubcf4\ub2c8","count":249,"count_type":0,"status":1,"sold":1}}');
	...
	<script async="true">
		//---------------------------------------------
		var real_item = "29976"; // 상품코드
		//---------------------------------------------
		// 아래 부분은 수정 불가

		var real_cic = "dsp12892";
		...
		function loadanal_sp(b) {
			loadanalJS_sp(("https:" == document.location.protocol ? "https://"
					: "http://")
					+ b, "UTF-8");
		}
			...
			return {
				onload : function(p) {
					...
					var u = p
							...
							+ "DTL" + e(f + le + "38,105,116,101,109,61" + ri)
							+ real_item + e(f + le + "38,99,105,99,61" + ri)
							+ real_cic;
	...
	<script type="text/javascript"
		...
		charset="utf-8"></script>
	<script type="text/javascript"
		src="//cdn.ggumim.co.kr/resource/house_interior_web/ggumim-1.2.04.min.js"></script>
	<script>
	...
	<script>
		...
		fbq('init', '1952412534769617');
		fbq('track', 'PageView');
	</script>
	<script>
		fbq('trackCustom', 'AppType', {
			app_chk : 'true'
		});
		// 보고있는 상품정보
		...
		function fbq_AddToCart(furniture_idx) {
			// 장바구니에 상품담기
			fbq('track', 'AddToCart', {
				content_ids : furniture_idx,
				content_type : 'product'
			});
		}
	</script>
	...
	<script type="text/javascript">
		!function(h, e, a, r, i, n, c) {
			...
			if (h.hearinaJs) {
				...
				'//cdn.hearina.com/js/luna-vanilla-js.min.js');
	</script>
	...
	<script type="text/javascript">
		!function(h, e, a, r, i, n, c) {
			...
			if (h.hearinaJs) {
				...
				'//cdn.hearina.com/js/luna_hearina_v.0.4.js');
	</script>
	<!-- luna herina script end -->
