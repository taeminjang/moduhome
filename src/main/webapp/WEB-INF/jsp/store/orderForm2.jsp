           ...
           <div id="content">
                <div id="order">
               		<dl class="loc-navi">
                        ...
                        <dd>
                            <a href="/MODA/main">home</a> &gt; 주문서 작성
                        </dd>
                    </dl>
                    <h2 class="tit-page">
...
<br>
<br>
<script src="/MODA/theme/aboki/js/sendGoods.js" type="text/javascript"></script>
<script src="/MODA/theme/aboki/js/copyright2.js" type="text/javascript"></script>
