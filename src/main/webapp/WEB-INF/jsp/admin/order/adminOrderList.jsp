							...
							<table
								...
								<tbody>
									<c:forEach var="orderList" items="${orderList}"
										varStatus="stat">
										<c:url var="viewURL" value="orderDetail">
										...
										<tr class="gradeA even" role="row">
											...
											<td style="text-align: center; vertical-align: middle;">
												...
												${orderList.GOODS_OPTION1} / ${orderList.GOODS_OPTION2 } /
											...
											<td style="text-align: center; vertical-align: middle;">
												...
												<c:if test="${orderList.ORDER_STATE ne '주문진행중'}">
											...
											<td style="text-align: center; vertical-align: middle;">
												...
												<c:url var="viewURL2" value="orderDelete">
													<c:param name="ORDER_CODE" value="${orderList.ORDER_CODE }" />
